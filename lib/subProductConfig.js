...
export const SUB_PRODUCT_CONFIG = {
  ...
  menus: {
    category: "marketing-business-print",
    slugPrefix: "menus-",
    dbSlugs: ["menus", "menus-flat", "menus-folded", "menus-laminated", "menus-takeout", "table-mat"],
  },
  envelopes: {
    category: "marketing-business-print",
  ...
  "floor-graphics": {
    category: "windows-walls-floors",
    slugPrefix: "floor-",
    dbSlugs: ["floor-graphics", "warehouse-floor-graphics", "warehouse-floor-safety-graphics", "floor-arrows", "floor-number-markers", "floor-decals", "floor-direction-arrows-set", "floor-logo-graphic", "floor-number-markers-set"],
  },
  "window-graphics": {
    category: "windows-walls-floors",
    slugPrefix: "window-",
  ...
  "sticker-rolls": {
    category: "stickers-labels-decals",
    slugPrefix: "roll-",
    dbSlugs: ["roll-labels", "stickers-roll-labels", "labels-roll-quote", "clear-labels", "white-bopp-labels", "kraft-paper-labels", "freezer-labels", "barcode-labels", "qr-code-labels"],
  },
  "vinyl-lettering": {
    category: "stickers-labels-decals",
    slugPrefix: "vinyl-",
  ...
  "classic-canvas-prints": {
    ...
    slugPrefix: "canvas-",
    dbSlugs: ["canvas-standard"],
  },
  "floating-frame-canvas": {
    category: "canvas-prints",
    slugPrefix: "canvas-",
    dbSlugs: ["canvas-gallery-wrap", "canvas-framed"],
  },
  "large-format-canvas": {
    category: "canvas-prints",
    slugPrefix: "canvas-",
    dbSlugs: ["canvas-panoramic"],
  },
  "canvas-collages": {
    category: "canvas-prints",
    slugPrefix: "canvas-",
    dbSlugs: ["canvas-split-2", "canvas-split-5"],
  },
  ...
  "tabletop-displays": {
    category: "banners-displays",
    slugPrefix: "tabletop-",
    dbSlugs: ["tabletop-banner-a4", "tabletop-banner-a3", "deluxe-tabletop-retractable-a3", "tabletop-signs", "rigid-tabletop-signs", "table-easel-display", "branded-table-cover-6ft", "branded-table-runner", "table-cloth", "standoff-hardware-set", "velcro-strips", "installation-service"],
  },
  "backdrops-popups": {
    category: "banners-displays",
    slugPrefix: "backdrop-",
  ...
  "hazard-warning": {
    category: "stickers-labels-decals",
    slugPrefix: "hazard-",
    dbSlugs: ["hazard-ghs-labels", "no-smoking-decals-set", "stay-back-warning-decals", "safety-notice-decal-pack", "parking-lot-stencils", "confined-space-warning-signs", "slip-trip-hazard-signs", "reflective-conspicuity-tape-kit", "high-visibility-rear-chevron-kit", "reflective-safety-stripes-kit"],
  },
  "ppe-equipment": {
    category: "stickers-labels-decals",
    slugPrefix: "ppe-",
