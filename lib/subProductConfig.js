...
export const SUB_PRODUCT_CONFIG = {
  ...
  "inserts-packaging": {
    category: "marketing-business-print",
    slugPrefix: "inserts-",
    dbSlugs: ["inserts-packaging", "packaging-inserts", "product-inserts", "packing-slips", "sticker-seals", "thank-you-cards", "box-sleeves"],
  },
  ...
  "hazard-warning": {
    category: "stickers-labels-decals",
    slugPrefix: "hazard-",
    dbSlugs: ["hazard-ghs-labels", "no-smoking-decals-set", "stay-back-warning-decals", "safety-notice-decal-pack", "parking-lot-stencils", "confined-space-warning-signs", "slip-trip-hazard-signs", "reflective-conspicuity-tape-kit", "high-visibility-rear-chevron-kit", "reflective-safety-stripes-kit", "safety-labels"],
  },
  "ppe-equipment": {
    category: "stickers-labels-decals",
    slugPrefix: "ppe-",
  ...
  "shelf-displays": {
    category: "marketing-business-print",
    slugPrefix: "shelf-",
    dbSlugs: ["shelf-displays", "wobblers", "danglers", "shelf-talkers"],
  },
  "table-tents": {
    category: "marketing-business-print",
    slugPrefix: "table-",
  ...
  "warehouse-labels": {
    ...
    dbSlugs: ["warehouse-zone-labels", "rack-labels-warehouse", "aisle-markers-hanging", "dock-door-numbers", "industrial-labels"],
  },
