...
export const SUB_PRODUCT_CONFIG = {
  ...
  "kiss-cut-singles": {
    category: "stickers-labels-decals",
    slugPrefix: "kiss-cut-",
    dbSlugs: ["removable-stickers", "kiss-cut-stickers", "kiss-cut-sticker-sheets", "stickers-color-on-white", "stickers-color-on-clear", "holographic-singles", "foil-stickers", "clear-singles", "heavy-duty-vinyl-stickers"],
  },
  "sticker-rolls": {
    category: "stickers-labels-decals",
    slugPrefix: "roll-",
  ...
  "facility-asset-labels": {
    ...
    dbSlugs: [
      ...
      "valve-tags-engraved",
      "equipment-rating-plates",
      "aisle-markers-hanging",
      "pipe-markers-custom",
      "dock-door-numbers",
      "cable-panel-labels",
