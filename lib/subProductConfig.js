...
export const SUB_PRODUCT_CONFIG = {
  ...
  "real-estate-signs": {
    category: "signs-rigid-boards",
    slugPrefix: "re-",
    dbSlugs: ["real-estate-sign", "real-estate-agent-sign"],
  },
  "foam-board-signs": {
    category: "signs-rigid-boards",
    slugPrefix: "foam-",
    dbSlugs: ["custom-foam-board", "photo-board", "foam-board", "foam-board-easel", "foam-board-prints", "rigid-foam-board-prints", "foamboard-sheet-3-16", "foamboard-sheet-1-2"],
  },
  "a-frame-signs": {
    category: "signs-rigid-boards",
    slugPrefix: "aframe-",
