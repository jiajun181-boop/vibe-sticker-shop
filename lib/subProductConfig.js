...
export const SUB_PRODUCT_CONFIG = {
  ...
  "yard-signs": {
    ...
    slugPrefix: "yard-",
    dbSlugs: ["yard-sign", "yard-sign-h-frame", "yard-signs-coroplast", "yard-sign-panel-only", "directional-arrow-sign", "directional-arrow-signs", "coroplast-signs", "coroplast-yard-signs", "lawn-signs-h-stake", "double-sided-lawn-signs", "coroplast-sheet-4mm", "coroplast-sheet-6mm", "coroplast-sheet-10mm"],
  },
  "real-estate-signs": {
    category: "signs-rigid-boards",
    slugPrefix: "re-",
  ...
  "foam-board-signs": {
    category: "signs-rigid-boards",
    slugPrefix: "foam-",
    dbSlugs: ["custom-foam-board", "photo-board", "foam-board", "foam-board-easel", "foam-board-prints", "rigid-foam-board-prints", "foamboard-sheet-3-16", "foamboard-sheet-1-2", "tri-fold-presentation-board"],
  },
  "a-frame-signs": {
    category: "signs-rigid-boards",
    slugPrefix: "aframe-",
    dbSlugs: ["a-frame-sandwich-board", "a-frame-insert-prints"],
  },
  "election-signs": {
    category: "signs-rigid-boards",
    slugPrefix: "election-",
  ...
  "display-signs": {
    category: "signs-rigid-boards",
    slugPrefix: "display-",
    dbSlugs: ["handheld-sign", "handheld-signs", "table-easel-display", "acrylic-signs", "clear-acrylic-signs", "frosted-acrylic-signs", "aluminum-signs", "aluminum-composite", "acm-dibond-signs", "pvc-sintra-signs", "gatorboard-signs", "standoff-mounted-signs", "rigid-tabletop-signs", "tabletop-signs", "backdrop-board", "menu-boards", "construction-site-signs", "safety-signs", "wayfinding-signs", "parking-property-signs", "tags-tickets-rigid", "pvc-sheet-3mm", "qr-code-signs", "address-house-number-signs", "business-hours-sign", "ada-braille-signs"],
  },
