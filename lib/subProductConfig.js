...
export const SUB_PRODUCT_CONFIG = {
  ...
  "sticker-pages": {
    ...
    slugPrefix: "sticker-",
    dbSlugs: ["sticker-sheets", "sticker-packs"],
  },
  "die-cut-stickers": {
    category: "stickers-labels-decals",
    slugPrefix: "die-cut-",
  ...
  "kiss-cut-singles": {
    category: "stickers-labels-decals",
    slugPrefix: "kiss-cut-",
    dbSlugs: ["kiss-cut-stickers", "stickers-color-on-white", "stickers-color-on-clear", "holographic-singles", "foil-stickers", "clear-singles", "heavy-duty-vinyl-stickers"],
  },
  "sticker-rolls": {
    category: "stickers-labels-decals",
    slugPrefix: "roll-",
    dbSlugs: ["sticker-rolls", "roll-labels", "stickers-roll-labels", "clear-labels", "white-bopp-labels", "kraft-paper-labels", "freezer-labels", "barcode-labels", "qr-code-labels"],
  },
  "vinyl-lettering": {
    category: "stickers-labels-decals",
    slugPrefix: "vinyl-",
