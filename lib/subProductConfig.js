...
export const SUB_PRODUCT_CONFIG = {
  ...
  /* ─── business-forms (merged into marketing-prints) ──────────── */
  "business-forms": {
    category: "marketing-prints",
    slugPrefix: "bf-",
    dbSlugs: [
      "ncr-invoice-books", "order-form-pads", "release-waiver-forms",
      "bf-certificates", "bf-letterhead", "bf-notepads",
    ],
  },

  /* ─── large-format-graphics sub-groups ─────────────────────────── */
  "wall-graphics": {
  ...
  "floor-graphics": {
    ...
    dbSlugs: [
      ...
      "floor-arrows", "floor-number-markers", "floor-decals",
    ],
  },
