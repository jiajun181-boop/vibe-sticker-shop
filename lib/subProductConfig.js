...
export const SUB_PRODUCT_CONFIG = {
  ...
  "tabletop-displays": {
    category: "banners-displays",
    slugPrefix: "tabletop-",
    dbSlugs: ["tabletop-banner-a4", "tabletop-banner-a3", "deluxe-tabletop-retractable-a3", "tabletop-signs", "rigid-tabletop-signs", "table-easel-display", "branded-table-cover-6ft", "branded-table-runner", "table-cloth", "standoff-hardware-set", "double-sided-tape", "velcro-strips", "installation-service"],
  },
  "backdrops-popups": {
    category: "banners-displays",
    slugPrefix: "backdrop-",
