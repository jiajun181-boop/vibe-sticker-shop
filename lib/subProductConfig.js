...
export const SUB_PRODUCT_CONFIG = {
  ...
  "yard-signs": {
    ...
    slugPrefix: "yard-",
    dbSlugs: ["yard-sign", "yard-sign-h-frame", "yard-signs-coroplast", "yard-sign-panel-only", "directional-arrow-sign", "directional-arrow-signs", "coroplast-signs", "coroplast-yard-signs", "lawn-signs-h-stake", "double-sided-lawn-signs"],
  },
  "real-estate-signs": {
    category: "rigid-signs",
    slugPrefix: "re-",
  ...
  "foam-board-signs": {
    category: "rigid-signs",
    slugPrefix: "foam-",
    dbSlugs: ["custom-foam-board", "photo-board", "foam-board", "foam-board-easel", "foam-board-prints", "rigid-foam-board-prints"],
  },
  "a-frame-signs": {
    category: "rigid-signs",
    slugPrefix: "aframe-",
