...
export const STAMP_PRESETS = {
  "funny-approval-stamp": {
    ...
    tagline: "The perfect gag gift for coworkers. Pre-loaded with hilarious text — customize to your taste.",
    ctaLabel: "Customize Your Stamp",
    badge: "Great gag gift",
  },
  "custom-face-stamp": {
    ...
    halftoneHint: true,
    tagline: "Upload a face photo and we'll turn it into a halftone self-inking stamp. Perfect for personalized gifts, teacher stamps, and party favours.",
    ctaLabel: "Upload Your Face Photo",
  ...
  "book-name-stamp": {
    ...
    tagline: "Mark your personal library with a classic \"From the Library of\" stamp. Elegant fonts, quality self-inking mechanism.",
    ctaLabel: "Personalize Your Stamp",
    badge: "Book lovers",
  },
};
