...
export const PRINT_TYPE_GROUPS = [
  { id: "cards", label: "Business Cards & Cards" },
  { id: "flyers", label: "Flyers & Postcards" },
  { id: "brochures", label: "Brochures" },
  { id: "menus", label: "Menus & Food Service" },
  { id: "door-hangers", label: "Door Hangers" },
  { id: "letters", label: "Letters & Documents" },
  { id: "specialty", label: "Specialty Print" },
  { id: "retail", label: "Retail & Packaging" },
];
...
export const PRINT_TYPES = [
  // ─── Existing products (12) ─────────────────────────────────────────
  {
    ...
    sizes: [
      ...
      { label: '3.5" × 2" (Rounded Corners)', w: 3.5, h: 2 },
    ],
    papers: [
  ...
  },
  {
    ...
    moreSizes: 10,
    papers: [
      { id: "100lb-gloss", label: "100lb Gloss", default: true },
      { id: "100lb-matte", label: "100lb Matte" },
    ],
    sides: ["single"],
    finishings: ["none", "laminate-gloss", "laminate-matte"],
    quantityMode: "input",
    quantities: [1],
  },
  {
    ...
    papers: [
      { id: "14pt-gloss-laminated", label: "14pt Gloss Laminated", default: true },
      { id: "14pt-matte-laminated", label: "14pt Matte Laminated" },
    ],
    sides: ["single", "double"],
    finishings: [],
...

  {
    ...
    group: "letters",
    label: "Envelopes",
    subtitle: "Custom printed envelopes — business, catalog, and invitation sizes",
    sizes: [
      { label: '#10 Business (4.125" × 9.5")', w: 4.125, h: 9.5 },
      { label: 'A7 Invitation (5.25" × 7.25")', w: 5.25, h: 7.25 },
      { label: '6" × 9" Catalog', w: 6, h: 9 },
      { label: '9" × 12" Catalog', w: 9, h: 12 },
    ],
    papers: [
      { id: "24lb-white-wove", label: "24lb White Wove", default: true },
      { id: "28lb-white-wove", label: "28lb Bright White" },
  ...
  // ─── New products ───────────────────────────────────────────────────
  {
    ...
    sides: ["single", "double"],
    finishings: ["soft-touch", "laminate-gloss"],
  ...
  },
  {
    ...
    sizes: [
      { label: 'S-510 — Small', w: 1.5, h: 0.5, desc: '1.5" × 0.5" — 1 line, name or initials', useCase: 'Initial / Monogram' },
      { label: 'S-520 — Medium', w: 1.875, h: 0.75, desc: '1.875" × 0.75" — 1–2 lines', useCase: 'Name / Short text', recommended: true },
      { label: 'S-542 — Large', w: 2.375, h: 1.125, desc: '2.375" × 1.125" — 2–3 lines', useCase: 'Return address / Approval' },
      { label: 'S-827 — Standard', w: 2.0, h: 1.1875, desc: '2.0" × 1.19" — 2–4 lines', useCase: 'Address / Office use' },
      { label: 'R-512 — Mini Round', w: 0.5, h: 0.5, desc: '0.5" Round — Initials only', useCase: 'Monogram seal' },
      { label: 'R-524 — Small Round', w: 1, h: 1, desc: '1" Round — Short text + border', useCase: 'Signature / Logo seal' },
      { label: 'R-532 — Medium Round', w: 1.25, h: 1.25, desc: '1.25" Round — Company seal', useCase: 'Company / Notary seal', recommended: true },
      { label: 'R-552 — Large Round', w: 1.625, h: 1.625, desc: '1.625" Round — Full detail', useCase: 'Corporate seal / Large logo' },
    ],
    papers: [
  ...
  },
  {
    ...
    group: "specialty",
    label: "Notepads",
    subtitle: "Custom printed notepads — glue bound, chipboard backing",
    sizes: [
      { label: '4.25" × 5.5"', w: 4.25, h: 5.5 },
      { label: '5.5" × 8.5"', w: 5.5, h: 8.5 },
      { label: '8.5" × 11"', w: 8.5, h: 11 },
  ...
  },
  {
    ...
    papers: [
      { id: "14pt-gloss", label: "14pt Gloss", default: true },
      { id: "14pt-matte", label: "14pt Matte" },
      { id: "16pt-matte", label: "16pt Premium Matte" },
    ],
    sides: ["single", "double"],
    finishings: ["none", "soft-touch"],
    quantities: [100, 250, 500, 1000, 2500, 5000],
  ...
  },
  {
    ...
    subtitle: "Custom folders with pockets & business card slits",
    sizes: [
      { label: '9" × 12" Standard', w: 9, h: 12 },
    ],
    papers: [
      { id: "14pt-gloss", label: "14pt Gloss", default: true },
      { id: "14pt-matte", label: "14pt Matte" },
    ...
    extras: [
      {
        ...
        label: "Pockets",
        options: [
          { id: "single", label: "Single Pocket", surcharge: 0 },
          { id: "double", label: "Double Pockets", surcharge: 500 },
        ],
        default: "single",
      },
      {
        ...
        options: [
          ...
          { id: "slit", label: "Card Slit", surcharge: 200 },
        ],
        default: "none",
      },
    ],
...
const _slugAliases = {
  // business-cards-* aliases removed — each type has its own dedicated page now
  // (business-cards-classic, business-cards-gloss, etc. in /order/ routes)
  ...
  "posters-glossy": "posters",
  "posters-matte": "posters",
  "posters-adhesive": "posters",
  "posters-backlit": "posters",
...
export function getMarketingPrintType(typeId) {
  const direct = PRINT_TYPES.find((pt) => pt.id === typeId);
  if (direct) return direct;
  // Fallback: resolve through alias map
  const aliasId = _slugMap.get(typeId);
  if (aliasId && aliasId !== typeId) {
    const aliased = PRINT_TYPES.find((pt) => pt.id === aliasId);
