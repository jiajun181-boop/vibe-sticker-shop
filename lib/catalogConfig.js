...
const DEFAULTS = {
  ...
  categoryMeta: {
    ...
    "stickers-labels-decals": {
      ...
      subGroups: [
        ...
        { slug: "kiss-cut-sticker-sheets", title: "Kiss-Cut Sticker Sheets", titleZh: "半刀贴纸页", href: "/shop/stickers-labels-decals/kiss-cut-sticker-sheets" },
  ...
  departmentMeta: {
    ...
    "windows-walls-floors": { title: "Window, Wall & Floor Graphics", titleZh: "窗贴、墙贴与地贴" },
