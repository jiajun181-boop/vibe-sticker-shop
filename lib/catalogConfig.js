...
const DEFAULTS = {
  departments: [
    { key: "print-business", categories: ["marketing-business-print"] },
    { key: "labels-decals", categories: ["stickers-labels-decals"] },
    { key: "signage-display", categories: ["signs-rigid-boards", "banners-displays", "windows-walls-floors"] },
    { key: "vehicle-fleet", categories: ["vehicle-graphics-fleet"] },
  ],
  ...
  categoryMeta: {
    "marketing-business-print": {
      ...
      subGroups: [
        ...
        { slug: "letterhead-stationery", title: "Letterhead & Stationery", href: "/shop/marketing-business-print/letterhead-stationery" },
    ...
    "stickers-labels-decals": {
      ...
      subGroups: [
        ...
        { slug: "decals", title: "Decals", href: "/shop/stickers-labels-decals/decals" },
        { slug: "specialty", title: "Specialty", href: "/shop/stickers-labels-decals/specialty" },
    ...
    "signs-rigid-boards": {
      ...
      subGroups: [
        ...
        { slug: "a-frame-signs", title: "A-Frame Inserts", href: "/shop/signs-rigid-boards/a-frame-signs" },
    ...
    "banners-displays": {
      ...
      subGroups: [
        ...
        { slug: "a-frames-signs", title: "A-Frame Hardware", href: "/shop/banners-displays/a-frames-signs" },
        { slug: "lawn-yard-signs", title: "Lawn & Yard Signs", href: "/shop/banners-displays/lawn-yard-signs" },
    ...
    "windows-walls-floors": {
      ...
      subGroups: [
        ...
        { slug: "window-graphics", title: "Architectural Window Graphics", href: "/shop/windows-walls-floors/window-graphics" },
      ],
    },
    "vehicle-graphics-fleet": {
      ...
      subGroups: [
        ...
        { slug: "vehicle-graphics", title: "Vehicle Graphics", href: "/shop/vehicle-graphics-fleet/vehicle-graphics" },
  ...
  departmentMeta: {
    "print-business": { title: "Print & Business" },
    "labels-decals": { title: "Labels & Decals" },
    "signage-display": { title: "Signage & Displays" },
