...
const DEFAULTS = {
  departments: [
    ...
    { key: "custom-stickers", categories: ["custom-stickers"] },
  ...
  categoryMeta: {
    ...
    "custom-stickers": {
      ...
      icon: "\u2B50",
      subGroups: [
        { slug: "stickers", title: "Custom Stickers", href: "/shop/custom-stickers/stickers" },
        { slug: "labels", title: "Custom Labels", href: "/shop/custom-stickers/labels" },
        { slug: "decals", title: "Custom Decals", href: "/shop/custom-stickers/decals" },
      ],
    },
    "stickers-labels-decals": {
  ...
  departmentMeta: {
    ...
    "custom-stickers": { title: "Custom Stickers" },
