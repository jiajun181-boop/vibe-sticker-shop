...
const DEFAULTS = {
  ...
  departmentMeta: {
    ...
    "signs-displays":   {
      ...
      subSections: [
        { label: "By Surface", labelZh: "按用途", categories: ["window-glass-films", "large-format-graphics", "vehicle-branding-advertising"] },
        { label: "Hardware & More", labelZh: "硬件 & 更多", categories: ["banners-displays", "display-stands", "fleet-compliance-id"] },
      ],
    },
