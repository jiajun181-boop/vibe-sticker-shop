...
export function assessItem(item, orderId) {
  ...
  const registrationMarkReady = contourReady && !!meta.contourAppliedAt;
  const manualReviewRequired = isPrintAndCut && (
    (meta.contourConfidence != null && meta.contourConfidence < 0.7) ||
    (meta.contourShapeType === "complex")
  );
