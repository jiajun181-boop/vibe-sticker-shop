...
const STATUS_MAP = {
  ...
  // ── Invoice ──
  sent:             { color: BLUE,   key: "admin.status.sent" },
  overdue:          { color: RED,    key: "admin.status.overdue" },
  void:             { color: GRAY,   key: "admin.status.void" },
...
export function invoiceColor(status) {
  return INVOICE_MAP[status] || GRAY;
}
