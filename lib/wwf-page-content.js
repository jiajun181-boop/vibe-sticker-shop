...
export const WWF_PAGE_CONTENT = {
  "one-way-vision": {
    seo: {
      title: "One-Way Vision Window Film | Perforated Vinyl",
  ...
  "frosted-window-film": {
    seo: {
      title: "Frosted Window Film | Etched Glass Effect",
  ...
  "static-cling": {
    seo: {
      title: "Static Cling Window Film | No Adhesive",
  ...
  "transparent-color-film": {
    seo: {
      title: "Transparent Color Window Film | Translucent Vinyl",
  ...
  "blockout-vinyl": {
    seo: {
      title: "Blockout Window Vinyl | Full Coverage Graphics",
  ...
  "opaque-window-graphics": {
    seo: {
      title: "Opaque Window Graphics | White Vinyl for Glass",
  ...
  "glass-waistline": {
    seo: {
      title: "Glass Waistline Strips | Safety Manifestation",
  ...
  "wall-graphics": {
    seo: {
      title: "Custom Wall Graphics | Repositionable Vinyl",
  ...
  "floor-graphics": {
    seo: {
      title: "Custom Floor Graphics | Non-Slip Vinyl",
  ...
  "decals": {
    seo: {
      title: "Custom Vinyl Decals Toronto | Indoor & Outdoor",
      description: "Custom printed vinyl decals for windows, walls, vehicles, and equipment. Die-cut or rectangular, indoor and outdoor rated. Fast turnaround in Toronto.",
      keywords: ["custom decals", "vinyl decals", "die cut decals", "window decals", "wall decals", "outdoor decals"],
    },
    intro: {
      headline: "Custom Decals",
      subtitle: "Durable vinyl decals for any surface — windows, walls, vehicles, equipment, and more. Available in die-cut contour or rectangular shapes, with optional lamination for outdoor durability.",
    },
    highlights: [
      { icon: "shield", text: "Indoor & outdoor rated" },
      { icon: "cut", text: "Die-cut or rectangular" },
      { icon: "clock", text: "3\u20135 business days" },
      { icon: "check", text: "Full-colour printing" },
    ],
    tabs: {
      specifications: {
        label: "Specifications",
        rows: [
          { label: "Material", value: "Premium white vinyl (3 mil)" },
          { label: "Printing", value: "Full-colour CMYK eco-solvent ink" },
          { label: "Adhesive", value: "Permanent, removable available on request" },
          { label: "Lamination", value: "Optional gloss or matte overlaminate" },
          { label: "Max Width", value: '53" (roll width)' },
          { label: "Durability", value: "3\u20135 years outdoor with laminate" },
        ],
      },
      installation: {
        label: "Application",
        content: "Clean the surface thoroughly with isopropyl alcohol. Peel backing and apply using a squeegee from center outward to avoid air bubbles. For large decals, use wet application method with soapy water.",
      },
    },
    useCases: [
      { title: "Window Signage", description: "Business hours, logos, and promotions on storefront glass." },
      { title: "Vehicle Graphics", description: "Fleet branding, door logos, and bumper decals." },
      { title: "Equipment Labels", description: "Durable asset tags, warning labels, and serial number plates." },
      { title: "Interior Branding", description: "Office wall logos, directional signage, and event graphics." },
    ],
    faq: [
      { q: "What's the difference between a decal and a sticker?", a: "Functionally they're the same — a vinyl graphic with adhesive backing. 'Decal' typically refers to larger or custom-shape graphics applied to surfaces like glass, walls, or vehicles." },
      { q: "Can decals be removed?", a: "Yes. Standard vinyl decals can be peeled off. Some adhesive residue may remain, which can be cleaned with isopropyl alcohol or adhesive remover." },
      { q: "Do I need lamination?", a: "For outdoor use, we recommend gloss or matte laminate to protect against UV fading, scratching, and weather. Indoor decals typically don't need lamination." },
    ],
  },
};
...
export const WWF_COMPARISON_TABLE = {
  columns: [
    ...
    { id: "decals", label: "Decals", slug: "decals" },
  ],
  rows: [
    {
      label: "Material",
    ...
    },
    {
      ...
      values: {
        ...
        "decals": "Windows, vehicles, equipment",
      },
    },
  ],
};
