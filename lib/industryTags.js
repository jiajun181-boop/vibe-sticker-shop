...
export const INDUSTRY_RELATED = {
  restaurants: ["retail", "event"],
  "real-estate": ["construction", "finance"],
  construction: ["fleet", "safety", "facility"],
  retail: ["beauty", "restaurants"],
  event: ["fitness", "beauty"],
  fleet: ["automotive", "safety", "construction"],
  safety: ["fleet", "construction", "facility"],
  facility: ["safety", "construction"],
  automotive: ["fleet"],
  finance: ["real-estate"],
  medical: ["safety", "facility"],
  education: ["event"],
