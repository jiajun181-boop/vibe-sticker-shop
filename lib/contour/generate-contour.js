...
export async function generateContour(imageUrl, opts = {}) {
  ...
  } else if (!hasAlpha && cfg.skipBgRemoval) {
    // Mobile skip — fall back to wrapping entire image
    console.info("Background removal skipped (mobile mode)");
  }
