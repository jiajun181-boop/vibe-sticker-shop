...
export { HST_RATE } from "@/lib/order-config";
...
function cleanOptionLabel(value) {
  ...
  // Remove trailing marker symbols copied from seed data, e.g. "3.5 x 2 ★" / "3.5 x 2*"
...
export function parseSizeOptions(optionsConfig) {
  ...
  return sizes
    ...
    .map((item) => ({
      ...
      displayLabel: typeof item.displayLabel === "string" ? cleanOptionLabel(item.displayLabel) : null,
