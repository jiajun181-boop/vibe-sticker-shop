...
export const COVER_PAPERS = [
  { id: "self-cover", label: "Self Cover (Same as Interior)" },
  { id: "100lb-gloss", label: "100lb Gloss Cover" },
  { id: "14pt-c2s", label: "14pt C2S Cover" },
];

export const COVER_COATINGS = [
  { id: "none", label: "No Coating" },
  { id: "gloss-lam", label: "Gloss Lamination" },
  { id: "matte-lam", label: "Matte Lamination" },
...
_slugToBinding.set("catalog-booklets", "perfect-bound");
