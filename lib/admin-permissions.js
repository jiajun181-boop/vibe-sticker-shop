...
export const MODULE_NAV_MAP = {
  ...
  orders: ["/admin/orders", "/admin/orders/missing-artwork", "/admin/orders/shipping", "/admin/orders/warranty", "/admin/quotes", "/admin/shipping"],
  ...
  production: ["/admin/production", "/admin/production/board", "/admin/production/mobile", "/admin/production/schedule", "/admin/production/rules", "/admin/qc", "/admin/orders/shipping", "/admin/shipping", "/admin/inventory"],
  ...
  content: ["/admin/content", "/admin/reviews", "/admin/marketing-calendar", "/admin/marketing/loyalty"],
  settings: ["/admin/settings", "/admin/system-health"],
  logs: ["/admin/logs"],
  apiKeys: ["/admin/api-keys"],
  users: ["/admin/users"],
  tools: ["/admin/tools", "/admin/tools/contour", "/admin/tools/proof", "/admin/tools/stamp-studio", "/admin/tools/unit-converter"],
...
const PAGE_ACCESS_RULES = [
  ...
  { prefix: "/admin/quotes", module: "pricing", action: "view" },
  { prefix: "/admin/orders/create", module: "orders", action: "edit" },
  { prefix: "/admin/orders/warranty", module: "orders", action: "view" },
  ...
  { prefix: "/admin/production/mobile", module: "production", action: "view" },
  ...
  { prefix: "/admin/marketing/loyalty", module: "content", action: "view" },
  ...
  { prefix: "/admin/system-health", module: "settings", action: "view" },
