...
export const PERMISSION_MATRIX = {
  ...
  cs: {
    ...
    b2b: "view",
    support: "edit",      // Handle customer support tickets
    shipping: "view",     // View shipment status
    logs: "view",
  },
  ...
  production: {
    ...
    shipping: "edit",     // Manage shipments
...
export const MODULE_NAV_MAP = {
  ...
  orders: ["/admin/orders", "/admin/shipping", "/admin/messages", "/admin/support"],
