...
const VARIANT_PAGES = {
  stickers: {
    ...
    metaTitle: "Custom Stickers | Die-Cut, Kiss-Cut, Holographic & More",
    metaDescription:
  ...
  labels: {
    category: "custom-stickers",
    title: "Custom Labels",
    metaTitle: "Custom Labels | Roll Labels, Clear BOPP, Kraft Paper",
    metaDescription:
  ...
  decals: {
    category: "custom-stickers",
    title: "Custom Decals",
    metaTitle: "Custom Decals | Window, Floor & Vinyl Lettering",
    metaDescription:
