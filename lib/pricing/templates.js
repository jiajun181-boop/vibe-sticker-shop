...
export function vinylPrint({ widthIn, heightIn, quantity, material, inkRate, lamination, options, marginCategory }) {
  ...
  // Print mode multipliers (white ink on transparent materials)
  const printModeMultipliers = { color_only: 1.0, white_only: 1.0, white_color: 1.30, color_white_color: 1.60 };
...
export function paperPrint({ widthIn, heightIn, quantity, paper, inkCostPerClick, options, lamination, marginCategory }) {
  ...
  // Double-sided surcharge: extra press run, handling, registration
