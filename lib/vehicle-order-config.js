...
export const VEHICLE_TYPE_GROUPS = [
  ...
  { id: "decals", label: "Decals & Magnets" },
  { id: "compliance", label: "Compliance & Numbering" },
];
...
export const VEHICLE_TYPES = [
  {
    ...
    fromPrice: 0,    // cents — set a value to show "Starting from $X" on quote-only UI
...
// ─── UI types for split pages ───

export const WRAP_UI_TYPES = [
  { id: "full-wrap", icon: "full" },
  { id: "partial-wrap", icon: "partial" },
  { id: "door-graphics", icon: "door" },
];

export const DECAL_UI_TYPES = [
  { id: "company-lettering" },
  { id: "dot-mc" },
  { id: "unit-numbers" },
];

export const WRAP_SLUG_MAP = {
  "full-wrap": "full-vehicle-wrap-design-print",
  "partial-wrap": "partial-wrap-spot-graphics",
  "door-graphics": "printed-truck-door-decals-full-color",
};

export const DECAL_SLUG_MAP = {
  "company-lettering": "long-term-outdoor-vehicle-decals",
  "dot-mc": "usdot-number-decals",
  "unit-numbers": "fleet-unit-number-stickers",
};
