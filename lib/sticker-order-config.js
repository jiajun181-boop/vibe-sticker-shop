...
export const TURNAROUND_OPTIONS = [
  ...
  { id: "rush", label: "stickerOrder.turnaround.rush", desc: "stickerOrder.turnaround.rushDesc", multiplier: RUSH_MULTIPLIER },
];

/**
 * Print modes for white ink materials.
 * Used by InlineConfigurator (generic sticker builder).
 * Die-cut / kiss-cut dedicated pages use WhiteInkStep instead,
 * which provides white underlay only (auto / follow / upload).
 */
...
export const CUTTING_TYPES = [
  ...
  },
  {
    ...
    shapes: STICKER_SHAPES,
    windDirections: [
      { id: "any",    label: "stickerOrder.wind.any",    desc: "stickerOrder.wind.anyDesc",    surchargeMultiplier: 1.0 },
      { id: "top",    label: "stickerOrder.wind.top",    desc: "stickerOrder.wind.topDesc",    surchargeMultiplier: 1.1 },
      { id: "bottom", label: "stickerOrder.wind.bottom", desc: "stickerOrder.wind.bottomDesc", surchargeMultiplier: 1.1 },
      { id: "right",  label: "stickerOrder.wind.right",  desc: "stickerOrder.wind.rightDesc",  surchargeMultiplier: 1.1 },
      { id: "left",   label: "stickerOrder.wind.left",   desc: "stickerOrder.wind.leftDesc",   surchargeMultiplier: 1.1 },
    ],
...
// ── Option detail metadata (display-only, no pricing logic) ──

/** Recommended defaults for each step */
export const RECOMMENDED = {
  material: "white-vinyl",
  lamination: "gloss",
  printMode: "white_color",
  turnaround: "standard",
};

/** Material comparison metadata — keys reference i18n option.* keys */
export const MATERIAL_DETAILS = {
  "white-vinyl":         { priceKey: "base",    useKey: "whiteVinyl",      durKey: "3to5yr" },
  "matte-vinyl":         { priceKey: "base",    useKey: "matteVinyl",      durKey: "3to5yr" },
  "clear-vinyl":         { priceKey: "plus15",  useKey: "clearVinyl",      durKey: "3to5yr" },
  "frosted-vinyl":       { priceKey: "plus32",  useKey: "frostedVinyl",    durKey: "3to5yr" },
  "holographic-vinyl":   { priceKey: "plus35",  useKey: "holoVinyl",       durKey: "2to3yr" },
  "3m-reflective":       { priceKey: "plus25",  useKey: "reflective",      durKey: "5to7yr" },
  "heavy-duty-vinyl":    { priceKey: "plus15",  useKey: "heavyDuty",       durKey: "5to7yr" },
  "gloss-paper":         { priceKey: "minus15", useKey: "glossPaper",      durKey: "indoor" },
  "matte-paper":         { priceKey: "minus15", useKey: "mattePaper",      durKey: "indoor" },
  "soft-touch-paper":    { priceKey: "plus12",  useKey: "softTouch",       durKey: "indoor" },
  "foil-stamping":       { priceKey: "plus50",  useKey: "foilStamping",    durKey: "indoor" },
  "clear-static-cling":  { priceKey: "plus12",  useKey: "clearCling",      durKey: "3to5yr" },
  "frosted-static-cling":{ priceKey: "plus12",  useKey: "frostedCling",    durKey: "3to5yr" },
  "white-static-cling":  { priceKey: "plus12",  useKey: "whiteCling",      durKey: "3to5yr" },
  "white-gloss-bopp":    { priceKey: "base",    useKey: "whiteGlossBOPP",  durKey: "3to5yr" },
  "clear-bopp":          { priceKey: "plus10",  useKey: "clearBOPP",       durKey: "3to5yr" },
  "silver-brushed-bopp": { priceKey: "plus25",  useKey: "silverBOPP",      durKey: "3to5yr" },
  "freezer-grade-bopp":  { priceKey: "plus15",  useKey: "freezerBOPP",     durKey: "3to5yr" },
};

export const LAMINATION_DETAILS = {
  none:         { priceKey: "base",    useKey: "lamNone",  durKey: "1to2yr" },
  gloss:        { priceKey: "plus10",  useKey: "lamGloss", durKey: "3to5yr" },
  "matte-lam":  { priceKey: "plus10",  useKey: "lamMatte", durKey: "3to5yr" },
};

export const PRINT_MODE_DETAILS = {
  color_only:        { priceKey: "base",    useKey: "colorOnly" },
  white_only:        { priceKey: "base",    useKey: "whiteOnly" },
  white_color:       { priceKey: "plus10",  useKey: "whiteColor" },
  color_white_color: { priceKey: "plus20",  useKey: "colorWhiteColor" },
};

export const TURNAROUND_DETAILS = {
  standard: { priceKey: "base",    useKey: "standard", deliveryKey: "2to3days" },
  rush:     { priceKey: "plus50",  useKey: "rush",     deliveryKey: "1day" },
};
