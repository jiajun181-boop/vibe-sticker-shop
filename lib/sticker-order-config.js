...
export const CUTTING_TYPES = [
  ...
  },
  {
    ...
    shapes: STICKER_SHAPES,
    windDirections: [
      { id: "any", label: "stickerOrder.wind.any", surchargeMultiplier: 1.0 },
      { id: "top", label: "stickerOrder.wind.top", surchargeMultiplier: 1.1 },
      { id: "bottom", label: "stickerOrder.wind.bottom", surchargeMultiplier: 1.1 },
      { id: "right", label: "stickerOrder.wind.right", surchargeMultiplier: 1.1 },
      { id: "left", label: "stickerOrder.wind.left", surchargeMultiplier: 1.1 },
    ],
