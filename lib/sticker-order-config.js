...
export const CUTTING_TYPES = [
  {
    ...
    materials: [
      ...
      { id: "matte-vinyl", multiplier: 1.0 },
      { id: "clear-vinyl", multiplier: 1.15 },
      { id: "frosted-vinyl", multiplier: 1.32 },
      { id: "holographic-vinyl", multiplier: 1.35 },
      { id: "3m-reflective", multiplier: 1.25 },
      { id: "heavy-duty-vinyl", multiplier: 1.15 },
      // Paper
      { id: "gloss-paper", multiplier: 0.85 },
      { id: "matte-paper", multiplier: 0.85 },
      { id: "soft-touch-paper", multiplier: 1.12 },
      { id: "foil-stamping", multiplier: 1.50 },
      // Static Cling
      { id: "clear-static-cling", multiplier: 1.12 },
      { id: "frosted-static-cling", multiplier: 1.12 },
      { id: "white-static-cling", multiplier: 1.12 },
    ],
    lamination: [
    ...
    slugMap: {
      ...
      "gloss-paper": "die-cut-stickers",
      "matte-paper": "die-cut-stickers",
      "soft-touch-paper": "die-cut-stickers",
      "foil-stamping": "die-cut-stickers",
  ...
  },
  {
    ...
    slugMap: {
      ...
      "gloss-paper": "kiss-cut-stickers",
      "matte-paper": "kiss-cut-stickers",
      "soft-touch-paper": "kiss-cut-stickers",
      "foil-stamping": "kiss-cut-stickers",
    },
    shapes: STICKER_SHAPES,
  },
  {
  ...
  },
  {
    ...
    materials: [
      ...
      { id: "matte-white-bopp", multiplier: 1.0 },
