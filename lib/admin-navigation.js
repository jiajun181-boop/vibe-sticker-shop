export const ADMIN_NAV_ITEMS = {
  ...
  production: {
    ...
    icon: "printer",
    matches: ["/admin/production", "/admin/production/board", "/admin/production/schedule", "/admin/production/rules"],
  },
  shipping: {
    id: "shipping",
  ...
  pricingRules: {
    ...
    icon: "pricing",
    matches: ["/admin/pricing-dashboard", "/admin/pricing"],
  },
  materials: {
    id: "materials",
  ...
  analyticsReports: {
    ...
    icon: "chart",
    matches: ["/admin/analytics", "/admin/funnel", "/admin/reports/sales", "/admin/reports/production"],
  },
  finance: {
    id: "finance",
...
const NAV_SECTIONS = {
  ...
  products: {
    ...
    items: ["productOps", "pricingRules", "materials", "media", "coupons", "inventory", "content"],
  },
  tools: {
    id: "tools",
  ...
  settings: {
    ...
    items: ["analyticsReports", "finance", "users", "apiKeys", "activityLog", "settings", "factories"],
  },
};
