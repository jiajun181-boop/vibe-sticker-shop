...
// Group definitions for Step 1 visual grouping
export const BANNER_TYPE_GROUPS = [
  { id: "banners", label: "Banners" },
  { id: "displays", label: "Display Stands" },
  { id: "flags", label: "Flags" },
  { id: "backdrops", label: "Backdrops & Tables" },
];
...
export const BANNER_TYPES = [
  ...
  },
  {
    ...
    hasDimensions: false,
    materials: [
      { id: "pet-grey-back", label: "PET Grey Back", multiplier: 1.0 },
    ],
    finishings: [],
    defaultFinishings: [],
    sizes: [
...
export const FINISHING_OPTIONS = {
  hems: { label: "Heat-Welded Hems", desc: "Sealed edges for durability", surcharge: 0 },
  grommets: { label: "Grommets (every 2ft)", desc: "Metal rings for rope/hook hanging", surcharge: 0 },
  "pole-pockets": { label: "Pole Pockets", desc: "Sleeves sewn in for poles", surcharge: 50 }, // cents/unit
  "wind-slits": { label: "Wind Slits", desc: "Small cuts to reduce wind stress", surcharge: 25 },
};
...
const _bannerSlugAliases = {
  ...
  "table-cloth": "tabletop",
  "outdoor-canopy-tent-10x10": "backdrop",
  "tent-custom-print": "backdrop",
  "tent-half-walls": "backdrop",
  "tent-walls-set": "backdrop",
};
