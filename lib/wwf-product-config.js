...
export const WWF_PRODUCTS = [
  {
    ...
    slug: "one-way-vision",
    name: "One-Way Vision",
    description: "See-through perforated vinyl for storefronts. Full graphics on outside, clear view from inside. Single-sided print, applied to outside of glass.",
    fixedMaterial: "perforated-vinyl",
    application: "glass-exterior",
  ...
  },
  {
    ...
    description: "Standard white vinyl with air-release adhesive, applied to glass for bold, full-colour window signage and lettering. Available in gloss or matte laminate.",
  ...
  },
  {
    ...
    slug: "decals",
    name: "Custom Decals",
    description: "Durable vinyl decals for windows, walls, vehicles, and equipment. Indoor or outdoor rated, with contour or rectangular cut.",
    fixedMaterial: "white-vinyl",
    application: "general",
    cutTypes: ["rectangular", "contour"],
    sizes: [
