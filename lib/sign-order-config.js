...
export const SIGN_TYPES = [
  ...
  // Acrylic signs removed — no UV flatbed printer available
  {
    id: "aluminum-sign",
  ...
  },
  {
    ...
    materialGroup: "coroplast",
    purchaseTypes: [
      { id: "panel-only", frameAccessory: null },
      { id: "frame-only", frameAccessory: "a-frame-stand" },
      { id: "full-kit",   frameAccessory: "a-frame-stand" },
    ],
    defaultPurchaseType: "full-kit",
    materials: [
      { id: "6mm-coroplast", label: "6mm Coroplast", multiplier: 1.0 },
      { id: "10mm-coroplast", label: "10mm Coroplast", multiplier: 1.25 },
    ],
    sizes: [
      { label: '24" × 36"', w: 24, h: 36 },
    ...
    customSize: true,
    accessories: ["grommets", "a-frame-stand"],
  ...
  },
  {
    ...
    materialGroup: "coroplast",
    purchaseTypes: [
      { id: "print-only", frameAccessory: null },
      { id: "frame-only", frameAccessory: "real-estate-frame" },
      { id: "full-kit",   frameAccessory: "real-estate-frame" },
    ],
    defaultPurchaseType: "full-kit",
    materials: [
      { id: "6mm-coroplast", label: "6mm Coroplast", multiplier: 1.0 },
    ...
    customSize: true,
    accessories: ["grommets", "real-estate-frame"],
    defaultAccessories: [],
    minIn: 12, maxW: 48, maxH: 48,
    quantities: [1, 5, 10, 25, 50, 100],
    doubleSided: true,
  },
  {
...
// Single source of truth for all sign accessory/hardware surcharges (cents).
// Sign configurators import from here — do NOT hardcode surcharges in components.
export const ACCESSORY_OPTIONS = {
  // ─── Ground mounting ───
  "h-stake": { label: "H-Stakes", desc: "Metal stakes for ground mounting", surcharge: 150 },
  "wire-stake": { label: "Wire Stakes", desc: "Wire legs for soft ground", surcharge: 100 },
  // ─── Stands & mounts ───
  "a-frame-stand": { label: "A-Frame Stand", desc: "Folding sidewalk stand", surcharge: 5150 },
  "easel-back": { label: "Easel Back", desc: "Built-in stand for tabletop", surcharge: 75 },
  standoffs: { label: "Standoff Mounts", desc: "Floating wall-mount hardware", surcharge: 400 },
  "wall-spacers": { label: "Wall Spacers", desc: "Wall-mount spacer kit", surcharge: 200 },
  // ─── Hanging & drilling ───
  grommets: { label: "Grommets", desc: "Metal rings for hanging (PVC/banner)", surcharge: 100 },
  "drilled-holes": { label: "Pre-Drilled Holes", desc: "Holes for screws/bolts", surcharge: 0 },
  "post-mount": { label: "Post-Mount Holes", desc: "Holes for post brackets", surcharge: 0 },
  // ─── Attachment ───
  "velcro-tabs": { label: "Velcro Tabs", desc: "Hook-and-loop mounting tabs", surcharge: 150 },
  "rider-clips": { label: "Rider Sign Clips", desc: "Clips for add-on rider sign", surcharge: 150 },
  "real-estate-frame": { label: "Real Estate L-Frame", desc: "Metal L-frame for lawn", surcharge: 1200 },
};
...
const _signSlugAliases = {
  ...
  // acrylic aliases removed — no UV flatbed printer
