...
export const SIGN_TYPES = [
  ...
  },
  {
    ...
    materials: [
      { id: "4mm-coroplast", label: "4mm Coroplast", multiplier: 1.0 },
      { id: "6mm-coroplast", label: "6mm Coroplast", multiplier: 1.25 },
      { id: "10mm-coroplast", label: "10mm Coroplast", multiplier: 1.5 },
    ...
    sizes: [
      ...
      { label: '24" × 36"', w: 24, h: 36 },
      { label: '12" × 18" (Rider)', w: 12, h: 18 },
      { label: '6" × 24" (Rider Strip)', w: 6, h: 24 },
    ],
    accessories: ["h-stake", "real-estate-frame", "rider-clips"],
    defaultAccessories: [],
    minIn: 6, maxW: 36, maxH: 48,
    quantities: [1, 5, 10, 25, 50, 100],
    doubleSided: true,
  },
  {
