...
export const STICKER_PAGE_CONTENT = {
  "die-cut": {
    seo: {
      title: "Custom Die-Cut Stickers | Waterproof Vinyl",
      description:
        ...
        content: [
          {
            ...
            text: "Free shipping on orders over $99. Standard delivery: 5–7 business days across Canada.",
          },
          {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Absolutely. Enter any dimensions from 0.5" × 0.5" up to 12" × 12". We also offer popular preset sizes for quick ordering.',
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes, we ship to all provinces and territories. Free shipping on orders over $99. Express 2–3 day shipping is also available.",
      },
    ],
  },
  ...
  "kiss-cut": {
    seo: {
      title: "Custom Kiss-Cut Stickers | Easy Peel & Apply",
      description:
    ...
    faq: [
      ...
      },
      {
        question: "Can I order custom sizes?",
        answer:
          'Yes — enter any dimensions from 0.5" × 0.5" up to 12" × 12" using the Custom size option in the configurator.',
      },
      {
        question: "How fast can I get my stickers?",
        answer:
  ...
  "sheets": {
    seo: {
      title: "Custom Sticker Sheets | Multi-Design Sheets",
      description:
  ...
  "roll-labels": {
    seo: {
      title: "Custom Roll Labels | BOPP, Kraft & Clear",
      description:
        "Order custom roll labels for product packaging, bottles, jars and retail. Waterproof BOPP, kraft paper, clear & silver options. Fast turnaround across Canada.",
      keywords: [
        "roll labels",
        "custom labels",
        "product labels",
        ...
        "kraft labels",
        "bottle labels",
        "label printing Canada",
      ],
    },
    intro: {
      headline: "Custom Roll Labels",
      subtitle:
        "Professional-grade labels on continuous rolls — perfect for product packaging, bottles, jars and retail labelling. Available in BOPP, kraft paper, clear and metallic finishes.",
    },
    highlights: [
      { icon: "circle", text: "Continuous roll format" },
      { icon: "droplets", text: "Waterproof BOPP options" },
      { icon: "clock", text: "Ships in 5–7 business days" },
      { icon: "shield", text: "Free digital proof included" },
    ],
    tabs: {
      specifications: {
        label: "Specifications",
        rows: [
          { label: "Materials", value: "White BOPP, Clear BOPP, Kraft Paper, Silver Metallic" },
          { label: "Adhesive", value: "Permanent, freezer-grade available" },
          { label: "Finish Options", value: "Gloss, Matte, Uncoated (Kraft)" },
          { label: "Durability", value: "Waterproof (BOPP), oil & chemical resistant" },
          { label: "Min Size", value: '1" × 1"' },
          { label: "Max Size", value: '12" × 18"' },
          { label: "Print Method", value: "Full-colour digital (CMYK), up to 1440 dpi" },
          { label: "Roll Core", value: '3" core, wound face out' },
          { label: "Min Order", value: "500 labels" },
          { label: "Turnaround", value: "5–7 business days (rush available)" },
        ],
      },
      artwork: {
        label: "Artwork Tips",
        content: [
          {
            heading: "File Format",
            text: "PDF, AI, EPS, or high-res PNG/TIFF. Vector files preferred for text and logos.",
          },
          {
            heading: "Resolution",
            text: "Minimum 300 DPI at actual print size.",
          },
          {
            heading: "Bleed & Safe Zone",
            text: 'Include 1/16" bleed beyond die line. Keep text 1/8" inside the cut edge.',
          },
          {
            heading: "Label Shapes",
            text: "Round, oval, rectangle, and custom shapes available. Include die-line on a separate layer.",
          },
        ],
      },
      shipping: {
        ...
        content: [
          ...
          {
            heading: "Packaging",
            text: "Labels ship on rolls, shrink-wrapped with protective end caps.",
          },
        ],
      },
    },
    useCases: [
      {
        title: "Food & Beverage",
        description: "Bottle labels, jar labels, and food packaging that withstand moisture and refrigeration.",
        image: null,
      },
      {
        title: "Cosmetics & Beauty",
        description: "Premium product labels for skincare, candles, soaps, and beauty products.",
        image: null,
      },
      {
        title: "Retail & E-Commerce",
        description: "Brand labels for packaging, shipping boxes, and product seals.",
        image: null,
      },
      {
        title: "Cannabis & Supplements",
        description: "Compliant product labels with regulatory info, barcodes, and tamper-evident options.",
        image: null,
      },
    ],
    faq: [
      {
        question: "What is a roll label?",
        answer:
          "Roll labels are custom-printed labels supplied on continuous rolls, designed for hand application or automatic label dispensers and applicators.",
      },
      {
        question: "What's the difference between BOPP and paper labels?",
        answer:
          "BOPP (biaxially-oriented polypropylene) labels are waterproof, oil-resistant, and tear-proof — ideal for products exposed to moisture. Paper labels (like kraft) have a natural look but are best for dry goods.",
      },
      {
        question: "Can I order custom shapes?",
        answer:
          "Yes! We offer round, oval, rectangle, square with rounded corners, and fully custom die-cut shapes.",
      },
      {
        question: "What's the minimum order?",
        answer:
          "Minimum order is 500 labels. Volume discounts are available for larger quantities.",
      },
      {
        question: "Are your labels food-safe?",
        answer:
          "Our BOPP labels use food-safe inks and adhesives. Freezer-grade adhesive is available for cold storage applications.",
      },
      {
        question: "Do you offer variable data printing?",
        answer:
          "Yes — we can print unique barcodes, QR codes, serial numbers, or batch codes on each label.",
      },
    ],
  },
};
...
const RICH_PAGE_SLUG_MAP = {
  // Die-cut (active + legacy aliases for URL routing)
