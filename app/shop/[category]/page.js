...
const SIGNS_PRODUCT_SECTIONS = [
  {
    ...
    title: "Outdoor & Real Estate \u2014 Weatherproof Signs",
    description: "Need a sign that survives rain, snow, and sun? Yard signs, real estate signs, directional signs, and construction boards \u2014 all built for Canadian outdoors.",
  ...
  {
    key: "events-weddings",
    title: "Events & Celebrations \u2014 Photo Boards & Displays",
    description: "One-time event? Selfie frames, welcome boards, seating charts, and giant cheques \u2014 perfect for weddings, graduations, and corporate events.",
  ...
  {
    key: "boards-material",
    title: "Indoor Display Boards \u2014 Choose by Material",
    description: "Need clean indoor signage? Foam board for presentations, coroplast for durability, PVC/acrylic for premium look. Priced by the square foot, any custom size.",
