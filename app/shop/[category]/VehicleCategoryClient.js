    ...
    >
      ...
      <div className="flex flex-1 flex-col p-3">
        ...
        <div className="mt-auto pt-2 flex items-center justify-between">
          ...
          <span className="inline-flex items-center gap-1 rounded-full bg-[var(--color-brand)] px-2.5 py-1 text-[9px] font-semibold uppercase tracking-[0.14em] text-white transition-colors group-hover:bg-[var(--color-brand-dark)]">
            View
