  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col p-2.5 sm:p-4">
        ...
        {group.description && (
          <p className="mt-0.5 text-[10px] sm:text-[11px] leading-snug text-[var(--color-gray-500)] line-clamp-1 sm:line-clamp-2">
            {group.description}
          </p>
        )}
...
function QuickQuoteFAB({ t }) {
  ...
  return (
    <Link
      ...
      style={{ bottom: "calc(var(--bottom-chrome, 72px) + 8px)" }}
    >
