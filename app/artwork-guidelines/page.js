    ...
    <main className="min-h-screen bg-gray-50 px-6 py-14 text-gray-900">
      <div className="mx-auto max-w-4xl space-y-10">
        ...
        <header className="rounded-3xl border border-gray-200 bg-white p-8 md:p-12">
          <p className="text-xs uppercase tracking-[0.25em] text-gray-500">Resources</p>
        ...
        <section className="rounded-3xl border border-gray-200 bg-white p-8 md:p-12">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-5">
              <p className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">File Formats</p>
              <p className="text-sm text-gray-700 font-medium">PDF, AI, PSD, JPG, PNG, TIF</p>
              <p className="text-xs text-gray-500 mt-1">AI/PSD recommended (CS6 or earlier)</p>
            </div>
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-5">
              <p className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Resolution</p>
              <p className="text-sm text-gray-700 font-medium">300 DPI minimum</p>
              <p className="text-xs text-gray-500 mt-1">1200 DPI recommended for small text &amp; fine details</p>
            </div>
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-5">
              <p className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Colour Mode</p>
              <p className="text-sm text-gray-700 font-medium">CMYK Only</p>
              <p className="text-xs text-gray-500 mt-1">RGB files are not accepted</p>
            </div>
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-5">
              <p className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Bleed</p>
              <p className="text-sm text-gray-700 font-medium">3 mm on all sides</p>
              <p className="text-xs text-gray-500 mt-1">Extend backgrounds and images to the bleed line</p>
            </div>
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-5">
              <p className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Fonts</p>
              <p className="text-sm text-gray-700 font-medium">Convert all text to outlines</p>
              <p className="text-xs text-gray-500 mt-1">Or embed all fonts in your PDF</p>
            </div>
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-5">
              <p className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Safe Zone</p>
              <p className="text-sm text-gray-700 font-medium">5 mm inside trim line</p>
              <p className="text-xs text-gray-500 mt-1">Keep important text &amp; logos in the safe area</p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-3xl border border-gray-200 bg-white p-8 md:p-12">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-bold text-gray-900">Colour Variations</h3>
            ...
            <div>
              <h3 className="text-sm font-bold text-gray-900">Black Text &amp; Backgrounds</h3>
              <p className="mt-2 text-sm text-gray-600 leading-relaxed">
            ...
            <div>
              <h3 className="text-sm font-bold text-gray-900">Borders &amp; Frames</h3>
              <p className="mt-2 text-sm text-gray-600 leading-relaxed">
            ...
            <div>
              <h3 className="text-sm font-bold text-gray-900">Folded Items</h3>
              <p className="mt-2 text-sm text-gray-600 leading-relaxed">
        ...
        <section className="rounded-3xl border border-gray-200 bg-white p-8">
          ...
          <div className="space-y-3 text-sm text-gray-600">
            ...
            <div className="flex items-start gap-3">
              <span className="mt-0.5 text-gray-400 font-bold">&mdash;</span>
