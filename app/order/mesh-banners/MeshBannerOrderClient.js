...
export default function MeshBannerOrderClient() {
  ...
  const [sizeIdx, setSizeIdx] = useState(0); // 3×6 default
    ...
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <Breadcrumbs
        items={[
          ...
          { label: t("mb.breadcrumb"), href: "/shop/signs-banners/mesh-banners" },
          { label: t("mb.order") },
        ]}
      />
      ...
      <div className="lg:grid lg:grid-cols-5 lg:gap-10">
        ...
        <div className="space-y-8 lg:col-span-3">
          ...
          {/* Sides */}
          <Section label={t("mb.sides.label")}>
            <div className="flex flex-wrap gap-2">
              {SIDES.map((s) => (
        ...
        <aside className="hidden lg:col-span-2 lg:block">
          <div className="sticky top-24 space-y-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <dl className="space-y-2 text-sm">
              ...
              <Row label={t("mb.sides.label")} value={t(`mb.sides.${sidesId}`)} />
            ...
            {quoteLoading ? (
              ...
              <dl className="space-y-2 text-sm">
                ...
                <Row label={t("mb.subtotal")} value={formatCad(adjustedSubtotal)} />
                ...
                <div className="pt-1">
                  <p className="text-[11px] text-gray-400">
                    {formatCad(Math.round(adjustedSubtotal / activeQty))}/{t("mb.each")}
                  </p>
                </div>
              </dl>
            ) : (
            ...
            {quoteLoading ? (
              ...
              <>
                ...
                <p className="truncate text-[11px] text-gray-500">
                  {activeQty.toLocaleString()} × {size.tag} {t(`mb.material.${materialId}`)}
                </p>
              </>
            ) : (
