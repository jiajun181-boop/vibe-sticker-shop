...
export function generateMetadata() {
  return {
    title: "Vinyl Lettering — Order Online",
...
export default async function VinylLetteringOrderPage() {
  const productImages = await getOrderPageImages(["vinyl-lettering"]);
  ...
  return (
    ...
    >
      <VinylLetteringOrderClient productImages={productImages} />
    </Suspense>
  );
}
