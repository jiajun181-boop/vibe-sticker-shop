  ...
  return (
    <main className="min-h-screen bg-[var(--color-gray-50)] px-4 py-14 text-[var(--color-gray-800)] sm:px-6">
      <div className="mx-auto max-w-[1400px] space-y-10 2xl:px-4">
        ...
        {/* Quick action cards — help customers pick the right path */}
        <div className="grid gap-4 sm:grid-cols-3">
          <a href="tel:+16477834728" className="rounded-2xl border border-[var(--color-gray-200)] bg-white p-5 transition-all hover:shadow-md hover:-translate-y-0.5 group">
            ...
            <p className="text-sm font-semibold text-[var(--color-gray-900)]">{t("contact.quickCall")}</p>
            <p className="mt-1 text-xs text-[var(--color-gray-500)]">{t("contact.quickCallDesc")}</p>
          </a>
          <a href="/quote" className="rounded-2xl border border-[var(--color-gray-200)] bg-white p-5 transition-all hover:shadow-md hover:-translate-y-0.5 group">
            ...
            <p className="text-sm font-semibold text-[var(--color-gray-900)]">{t("contact.quickQuote")}</p>
            <p className="mt-1 text-xs text-[var(--color-gray-500)]">{t("contact.quickQuoteDesc")}</p>
          </a>
          <a href="/shop" className="rounded-2xl border border-[var(--color-gray-200)] bg-white p-5 transition-all hover:shadow-md hover:-translate-y-0.5 group">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-100 text-amber-600 mb-3">
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 002.25 1.016c.896 0 1.7-.393 2.25-1.016a3.001 3.001 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72m-13.5 8.65h3.75a.75.75 0 00.75-.75V13.5a.75.75 0 00-.75-.75H6.75a.75.75 0 00-.75.75v3.15c0 .415.336.75.75.75z" /></svg>
            </div>
            <p className="text-sm font-semibold text-[var(--color-gray-900)]">{t("contact.quickShop")}</p>
            <p className="mt-1 text-xs text-[var(--color-gray-500)]">{t("contact.quickShopDesc")}</p>
          </a>
        </div>
