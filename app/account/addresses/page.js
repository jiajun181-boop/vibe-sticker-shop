    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {!showForm && (
          <button
            onClick={handleAdd}
            className="rounded-full border border-gray-900 bg-gray-900 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-white transition-colors hover:bg-gray-800"
          >
      ...
      {showForm && (
        <form onSubmit={handleSave} className="space-y-4 rounded-xl border border-gray-200 p-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label className="block text-[11px] font-semibold uppercase tracking-[0.2em] text-gray-400 mb-1">
          ...
          <label className="flex items-center gap-2">
            ...
            />
            <span className="text-sm text-gray-600">{t("account.addresses.setDefault")}</span>
          </label>
          ...
          <div className="flex items-center gap-3 pt-2">
            <button
              type="submit"
              disabled={saving}
              className="rounded-full bg-gray-900 px-5 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-white transition-colors hover:bg-gray-800 disabled:opacity-50"
            >
            ...
            <button
              ...
              className="rounded-full border border-gray-200 px-5 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-gray-600 transition-colors hover:bg-gray-50"
            >
      ...
      {addresses.length === 0 && !showForm && (
        <div className="rounded-xl border border-gray-200 p-8 text-center">
          <p className="text-sm text-gray-500">{t("account.addresses.empty")}</p>
        </div>
      )}
        ...
        {addresses.map((addr) => (
          <div
            ...
            className={`rounded-xl border p-4 ${
              addr.isDefaultShipping ? "border-gray-900 bg-gray-50" : "border-gray-200"
            }`}
          >
            <div className="flex items-start justify-between">
              <div className="space-y-1">
                ...
                {addr.name && <p className="text-sm font-medium text-gray-900">{addr.name}</p>}
                {addr.company && <p className="text-xs text-gray-500">{addr.company}</p>}
