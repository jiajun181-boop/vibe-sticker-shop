...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm rounded-[3px] bg-white p-6 shadow-2xl" role="alertdialog" aria-modal="true" aria-labelledby="confirm-title" aria-describedby="confirm-desc">
        <div className={`mx-auto flex h-10 w-10 items-center justify-center rounded-[3px] ${variant === "danger" ? "bg-red-100" : "bg-[#f5f5f5]"}`}>
          {variant === "danger" ? (
