  ...
  return (
    <div className="absolute top-3 right-3 z-30">
      ...
      <button
        ...
        disabled={uploading}
        className="flex items-center gap-1.5 rounded-lg bg-black/80 px-3 py-2 text-xs font-semibold text-white shadow-lg backdrop-blur transition-all hover:bg-black disabled:opacity-60"
