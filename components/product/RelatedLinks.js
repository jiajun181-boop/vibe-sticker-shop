      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {industries.length > 0 && (
          <div className="rounded-2xl border border-[var(--color-gray-200)] bg-white p-5">
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-[0.14em] text-[var(--color-gray-500)]">
              ...
              {industries.map((tag) => {
                ...
                return (
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 rounded-xl border border-[var(--color-gray-200)] bg-[var(--color-gray-50)] px-3 py-1.5 text-xs font-medium text-[var(--color-gray-700)] transition-colors hover:border-[var(--color-gray-300)] hover:bg-[var(--color-gray-100)]"
                  >
                    <span>{info.icon}</span>
