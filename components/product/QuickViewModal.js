  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Product image */}
        <div className="aspect-[4/3] relative w-full bg-[var(--color-gray-100)]">
          <Image
            src={imgSrc}
        ...
        <div className="p-5">
          ...
          {/* Product name */}
          <h3 className="mt-2 text-lg font-semibold text-[var(--color-gray-900)]">
            {product.name}
          </h3>

          {/* Price range */}
          <p className="mt-1 text-sm font-medium text-[var(--color-gray-700)]">
            {formatCad(base)} &ndash; {formatCad(high)}
          </p>

          {/* Description */}
          {product.description && (
            <p className="mt-2 line-clamp-3 text-sm text-[var(--color-gray-500)]">
              {product.description}
            </p>
          )}
          ...
          <div className="mt-5 flex items-center gap-3">
            <Link
              ...
              onClick={onClose}
              className="flex-1 rounded-lg border border-[var(--color-gray-300)] px-4 py-2.5 text-center text-sm font-medium text-[var(--color-gray-700)] transition-colors hover:bg-[var(--color-gray-50)]"
            >
              {t("shop.view")}
            </Link>
            <button
              ...
              className="flex-1 rounded-lg bg-[var(--color-ink-black)] px-4 py-2.5 text-center text-sm font-medium text-white transition-colors hover:bg-[var(--color-gray-800)]"
            >
              {t("shop.quickAdd")}
            </button>
          </div>
