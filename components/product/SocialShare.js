 ...
 * Renders share icons for Facebook, Twitter/X, Pinterest, WhatsApp, and copy-link.
 *
 * @param {{ url: string, title: string, description?: string, imageUrl?: string }} props
 */
export default function SocialShare({ url, title, description = "", imageUrl = "" }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-xs font-medium text-gray-500 uppercase tracking-wider">Share</span>
