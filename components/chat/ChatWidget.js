  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-[calc(theme(spacing.6)+72px+env(safe-area-inset-bottom))] right-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[var(--color-brand)] text-[#fff] shadow-lg hover:bg-[var(--color-brand-dark)] hover:scale-105 transition-all md:bottom-6 md:right-6"
