                ...
                {orders.map((order) => (
                  <div key={order.id} className="flex items-center justify-between rounded-xl bg-[var(--color-gray-50)] px-3 py-2.5">
                    ...
                    <button
                      ...
                      className="rounded-xl bg-[var(--color-moon-blue-deep)] px-3 py-1.5 text-[11px] font-semibold text-[#fff] disabled:opacity-50"
                    >
            ...
            {products.map((p) => (
              <div key={p.id} className="rounded-xl border border-[var(--color-gray-100)] bg-white p-2.5">
                ...
                <button
                  ...
                  className="mt-1.5 w-full rounded-full bg-[var(--color-moon-blue-deep)] py-1.5 text-[11px] font-semibold text-[#fff]"
                >
                  {t("shop.quickAdd")}
                </button>
              </div>
