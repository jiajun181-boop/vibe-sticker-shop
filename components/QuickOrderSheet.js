                ...
                {orders.map((order) => (
                  <div key={order.id} className="flex items-center justify-between rounded-xl bg-gray-50 px-3 py-2.5">
                    ...
                    <button
                      ...
                      className="rounded-full bg-gray-900 px-3 py-1.5 text-[11px] font-semibold text-white disabled:opacity-50"
                    >
            ...
            {products.map((p) => (
              <div key={p.id} className="rounded-xl border border-gray-100 bg-white p-2.5">
                ...
                <button
                  ...
                  className="mt-1.5 w-full rounded-full bg-gray-900 py-1.5 text-[11px] font-semibold text-white"
                >
                  {t("shop.quickAdd")}
                </button>
              </div>
