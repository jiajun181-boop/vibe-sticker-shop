...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // ── Sticker / label product slugs → /order/stickers configurator ──
      { source: "/shop/:cat/stickers-single-diecut", destination: "/order/stickers?type=die-cut", permanent: false },
      { source: "/shop/:cat/die-cut-singles", destination: "/order/stickers?type=die-cut", permanent: false },
      { source: "/shop/:cat/die-cut-stickers", destination: "/order/stickers?type=die-cut", permanent: false },
      { source: "/shop/:cat/clear-singles", destination: "/order/stickers?type=die-cut", permanent: false },
      { source: "/shop/:cat/holographic-singles", destination: "/order/stickers?type=die-cut", permanent: false },
      { source: "/shop/:cat/stickers-sheet-kisscut", destination: "/order/stickers?type=sheets", permanent: false },
      { source: "/shop/:cat/sticker-sheets", destination: "/order/stickers?type=sheets", permanent: false },
      { source: "/shop/:cat/kiss-cut-sticker-sheets", destination: "/order/stickers?type=kiss-cut", permanent: false },
      { source: "/shop/:cat/removable-stickers", destination: "/order/stickers?type=kiss-cut", permanent: false },
      { source: "/shop/:cat/roll-labels", destination: "/order/stickers?type=roll-labels", permanent: false },
      { source: "/shop/:cat/clear-labels", destination: "/order/stickers?type=roll-labels", permanent: false },
      { source: "/shop/:cat/white-bopp-labels", destination: "/order/stickers?type=roll-labels", permanent: false },
      { source: "/shop/:cat/kraft-paper-labels", destination: "/order/stickers?type=roll-labels", permanent: false },
      { source: "/shop/:cat/transfer-vinyl-lettering", destination: "/order/stickers?type=vinyl-lettering", permanent: false },
      { source: "/shop/:cat/vinyl-lettering", destination: "/order/stickers?type=vinyl-lettering", permanent: false },

      // ── Other product deduplication — old slugs to canonical ──
