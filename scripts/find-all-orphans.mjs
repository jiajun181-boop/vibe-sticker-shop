...
const CATEGORIES_WITH_SUBGROUPS = {
  "marketing-business-print": ["business-cards","flyers","rack-cards","door-hangers","postcards","brochures","booklets","posters","menus","ncr-forms","order-forms","waivers-releases","envelopes","letterhead","notepads","bookmarks","calendars","stamps","presentation-folders","certificates","greeting-invitation-cards","shelf-displays","table-tents","tickets-coupons","tags","inserts-packaging"],
  "stickers-labels-decals": ["die-cut-stickers","kiss-cut-singles","sticker-pages","sticker-rolls","vinyl-lettering","fire-emergency","hazard-warning","ppe-equipment","electrical-chemical","asset-equipment-tags","pipe-valve-labels","warehouse-labels","electrical-cable-labels"],
  ...
  "banners-displays": ["vinyl-banners","mesh-banners","pole-banners","fabric-banners","retractable-stands","x-banner-stands","tabletop-displays","trade-show-furniture","backdrops-popups","flags-hardware","tents-outdoor"],
  "canvas-prints": ["classic-canvas-prints","floating-frame-canvas","large-format-canvas","canvas-collages","triptych-canvas-split","hex-canvas-prints","rolled-canvas-prints"],
