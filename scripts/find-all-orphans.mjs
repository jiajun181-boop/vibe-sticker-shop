...
const CATEGORIES_WITH_SUBGROUPS = {
  ...
  "banners-displays": ["vinyl-banners","mesh-banners","pole-banners","fabric-banners","retractable-stands","x-banner-stands","tabletop-displays","backdrops-popups","flags-hardware","tents-outdoor"],
